...
const Navigation = ({
  ...
  function seventDaysWeatherHandler(data) {
    sevenDaysWeatherClicked();
    fetchWeather(data);
    navigate(`/seven-days-weather/${selectedCity}`, {
      state: { selectedCity },
    });
  }
      ...
      <Navbar bg="light" expand="lg">
        <Container fluid>
          <Button
            ...
            onClick={() => reloadHomepage(selectedCity)}
          >
            محطات الرصد الجوي
          </Button>
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            >
              <Button
                ...
                variant="outline-info m-2"
                style={{ fontWeight: "bold" }}
                onClick={() => seventDaysWeatherHandler(selectedCity)}
              >
                Forecast 3 days
              </Button>
              <Button
                ...
                variant="outline-info m-2"
                style={{ fontWeight: "bold" }}
                onClick={() => graphsHandler(selectedCity)}
              >
                Map
              </Button>
              <Button
                type="button"
                variant="outline-info m-2"
                className="arabic bbttnn"
                style={{
                  fontWeight: "bold",
                  paddingRight: 40,
                  paddingLeft: 40,
                }}
                onClick={() => weatherUpdateHourly(selectedCity)}
              >
                تحديث المعلومات
              </Button>
            </Nav>
            <Form className="d-flex ">
              <Form.Select
                ...
                dir="rtl"
                className="me-2 pl-2 arabic align-self-center"
                style={{
                  fontWeight: "bold",
                  width: 175,
                  height: 67,
              ...
              <Button
                className="bbttnn"
                variant="outline-info m-2 arabic"
                style={{ width: "12rem", fontSize: "1rem", fontWeight: "bold" }}
              >
                اسم المحطة
              </Button>
            </Form>
